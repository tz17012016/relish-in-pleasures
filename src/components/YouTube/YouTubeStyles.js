...
export const YouTubeContainer = styled.div`
  display: flex;
`;
export const YouTubeColumn = styled.div`
  /* margin-bottom: 15px; */
  padding: 50px;
  background: white;
  border: 20px;
...
export const YouTubeWrapper = styled.form`
  /* max-width: 540px; */
  padding-top: 0;
...
export const YouTubeMessage = styled(motion.div)`
...
export const YouTubeInputRow = styled.div`
  display: flex;
  justify-content: center;
  flex-direction: column;
  align-items: stretch;
...
export const YouTubeLabel = styled.label`
  ...
  color: #afafaf;
`;
export const YouTubeImgWrapper = styled.div`
  max-width: 555px;
  display: flex;
